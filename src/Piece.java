...
public abstract class Piece{
    ...
    public String getColorWord() {
        // complete this
    	if (this.getColorWord().equalsIgnoreCase("red"))
    		return "Red";
    	else if (this.getColorWord().equalsIgnoreCase("green"))
    		return "Green";
    	else if (this.getColorWord().equalsIgnoreCase("yellow"))
    		return "Yellow";
    	else if (this.getColorWord().equalsIgnoreCase("white"))
    		return "White";
    	else 
    		return null;
    }
